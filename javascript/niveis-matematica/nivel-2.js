try{
    ...
    const resultados = Array(11);
    const verificarCliques = [...resultados];
    ...
    resultados[3] = valoresSeccao3[0].innerHTML / valoresSeccao3[1].innerHTML;
    ...
    resultados[5] = Number(valoresSeccao5[0].innerHTML) + (valoresSeccao5[1].innerHTML * valoresSeccao5[2].innerHTML);
    ...
    avancarNivel3.addEventListener("click", ()=>{
        ...
        if(errado > 2){
            ...
            sessionStorage.setItem("nivel3ConcluidoComSucesso", true);

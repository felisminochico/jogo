...
valoresSeccao8[2].innerHTML = Number(Math.floor(Math.random() * ((16 - 7) + 1) + 9));
let resultadoSeccao8 = (Number(valoresSeccao8[0].innerHTML) / Number(valoresSeccao8[1].innerHTML)) - Number(valoresSeccao8[2].innerHTML);//Não terminado...

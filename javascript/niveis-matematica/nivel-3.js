...
try{
    ...
    function decimaPrimeiraSeccao(botao){
        verificarCliques[11] = botao.textContent
    ...
    function decimaSegundaSeccao(botao){
        verificarCliques[12] = botao.textContent
    ...
    function decimaTerceiraSeccao(botao){
        verificarCliques[13] = botao.textContent
    ...
    function decimaQuartaSeccao(botao){
        verificarCliques[14] = botao.textContent
    ...
    function decimaQuintaSeccao(botao){
        verificarCliques[15] = botao.textContent
